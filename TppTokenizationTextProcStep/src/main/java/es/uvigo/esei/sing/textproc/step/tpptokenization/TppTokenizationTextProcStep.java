 ...
 */
final class TppTokenizationTextProcStep extends AbstractTppTextProcStep {
	/**
	 * Instantiates a Text Processing Python tokenization processing step.
	 */
	TppTokenizationTextProcStep() {
		super(
			...
			Set.of(),
			// Result entity types
			List.of(TokenizedTextWithTitleDocument.class, TokenizedTextDocument.class),
