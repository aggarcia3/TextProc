...
public class TokenizedTextDocument extends ProcessedDocument {
	/**
	 ...
	 */
	public TokenizedTextDocument(final int id, final String text) {
		super(id, text);
	}
	 ...
	 */
	public TokenizedTextDocument(final Integer id) {
		super(id, "");
	}
	 ...
	 */
	protected TokenizedTextDocument() {}
}
