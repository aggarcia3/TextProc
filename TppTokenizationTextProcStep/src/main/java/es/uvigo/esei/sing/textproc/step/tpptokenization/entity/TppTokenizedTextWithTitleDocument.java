...
public class TppTokenizedTextWithTitleDocument extends ProcessedDocumentWithTitle {
	/**
	 ...
	 */
	public TppTokenizedTextWithTitleDocument(final int id, final String text, final String title) {
		super(id, text, title);
	}
	 ...
	 */
	public TppTokenizedTextWithTitleDocument(final Integer id) {
		super(id);
	}
	 ...
	 */
	protected TppTokenizedTextWithTitleDocument() {}
}
