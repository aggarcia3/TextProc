...
import es.uvigo.esei.sing.textproc.abstracttppstep.AbstractTppTextProcStep;
 ...
 */
final class TppStopwordFilteringTextProcStep extends AbstractTppTextProcStep {
	 ...
	 */
	public TppStopwordFilteringTextProcStep(@NonNull final AddLanguageParameterAction requestParametersAction) {
		super(
	 ...
	 * {@link #setStep(TppStopwordFilteringTextProcStep)} ASAP.
	 *
	 * @author Alejandro González García
	 */
	...
	static final class AddLanguageParameterAction implements ProcessingConsumer<JsonGenerator> {
		...
		private TppStopwordFilteringTextProcStep step;
