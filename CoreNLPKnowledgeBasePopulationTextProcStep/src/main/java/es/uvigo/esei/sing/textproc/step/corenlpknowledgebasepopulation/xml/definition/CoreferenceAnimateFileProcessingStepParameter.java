...
/**
 * Parameter for specifying the path of the animate file that will be read by
 * {@link Dictionaries}, which is a transitive dependency of
 * {@link CorefAnnotator}.
 *
 * @author Alejandro González García
 */
@XmlRootElement(name = "coreferenceAnimateFile")
public final class CoreferenceAnimateFileProcessingStepParameter extends AbstractProcessingStepParameter {}
