...
/**
 * Parameter for specifying the serialized word counts file that will be read by
 * {@link Dictionaries}, which is a transitive dependency of
 * {@link CorefAnnotator}.
 *
 * @author Alejandro González García
 */
@XmlRootElement(name = "coreferenceWordCounts")
public final class CoreferenceWordCountsProcessingStepParameter extends AbstractProcessingStepParameter {}
