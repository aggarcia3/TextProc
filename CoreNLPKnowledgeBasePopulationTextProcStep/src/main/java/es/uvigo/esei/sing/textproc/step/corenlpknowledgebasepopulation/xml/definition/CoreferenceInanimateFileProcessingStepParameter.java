...
/**
 * Parameter for specifying the path of the inanimate file that will be read by
 * {@link Dictionaries}, which is a transitive dependency of
 * {@link CorefAnnotator}.
 *
 * @author Alejandro González García
 */
@XmlRootElement(name = "coreferenceInanimateFile")
public final class CoreferenceInanimateFileProcessingStepParameter extends AbstractProcessingStepParameter {}
