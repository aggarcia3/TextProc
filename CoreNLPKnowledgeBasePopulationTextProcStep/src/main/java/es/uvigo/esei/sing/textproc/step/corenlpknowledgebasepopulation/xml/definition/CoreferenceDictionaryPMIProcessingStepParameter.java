...
/**
 * Parameter for specifying the dictionary PMI that will be read by
 * {@link Dictionaries}, which is a transitive dependency of
 * {@link CorefAnnotator}.
 *
 * @author Alejandro González García
 */
@XmlRootElement(name = "coreferenceDictionaryPMI")
public final class CoreferenceDictionaryPMIProcessingStepParameter extends AbstractProcessingStepParameter {}
