...
public class CoreNLPTokenizedTextDocument extends ProcessedDocument {
	/**
	 ...
	 */
	public CoreNLPTokenizedTextDocument(final int id, final String text) {
		super(id, text);
	}
	 ...
	 */
	public CoreNLPTokenizedTextDocument(final Integer id) {
		super(id, "");
	}
	 ...
	 */
	protected CoreNLPTokenizedTextDocument() {}
}
