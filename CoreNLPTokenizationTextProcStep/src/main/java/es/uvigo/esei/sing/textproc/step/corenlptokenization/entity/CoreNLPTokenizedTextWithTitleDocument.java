...
package es.uvigo.esei.sing.textproc.step.corenlptokenization.entity;
...
public class CoreNLPTokenizedTextWithTitleDocument extends ProcessedDocumentWithTitle {
	/**
	 ...
	 */
	public CoreNLPTokenizedTextWithTitleDocument(final int id, final String text, final String title) {
		super(id, text, title);
	}
	 ...
	 */
	public CoreNLPTokenizedTextWithTitleDocument(final Integer id) {
		super(id);
	}
	 ...
	 */
	protected CoreNLPTokenizedTextWithTitleDocument() {}
}
