 ...
 */
final class TppLemmatizationTextProcStep extends AbstractTppTextProcStep {
	 ...
	 */
	public TppLemmatizationTextProcStep(@NonNull final AddModelParameterAction requestParametersAction) {
		super(
	 ...
	 * {@link #setStep(TppLemmatizationTextProcStep)} ASAP.
	 *
	 * @author Alejandro González García
	 */
	...
	static final class AddModelParameterAction implements ProcessingConsumer<JsonGenerator> {
		...
		private TppLemmatizationTextProcStep step;
