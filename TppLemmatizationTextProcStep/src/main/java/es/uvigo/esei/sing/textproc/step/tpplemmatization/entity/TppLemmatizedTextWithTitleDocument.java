...
public class TppLemmatizedTextWithTitleDocument extends ProcessedDocumentWithTitle {
	/**
	 ...
	 */
	public TppLemmatizedTextWithTitleDocument(final int id, final String text, final String title) {
		super(id, text, title);
	}
	 ...
	 */
	public TppLemmatizedTextWithTitleDocument(final Integer id) {
		super(id);
	}
	 ...
	 */
	protected TppLemmatizedTextWithTitleDocument() {}
}
